...
/**
 * 替代org.springframework.cache.annotation.CacheEvict
 * 
 * @author shf675
 */
...
public @interface ICacheEvict {
	 ...
	 * irrespective of the method outcome (i.e., whether it threw an exception
	 * or not).
	 * <p>
	 * Defaults to {@code false}, meaning that the cache eviction operation
	 * will occur <em>after</em> the advised method is invoked successfully
	 * (i.e., only if the invocation did not throw an exception).
	 */
