...
*/
if (typeof FusionCharts === "undefined") throw alert("FusionChartsExport: object::FusionCharts was not found. Verify script inclusions.", 10901271400),
"FusionChartsExportComponentFatalError::10901271400";
var _FCEO = function() {
	_FCEO.initializeComponent(this, arguments)
},
FusionChartsExportObject = _FCEO;
if (FusionCharts.version && FusionCharts.version[0] >= 3) _FCEO.__global = FusionCharts(["private", "LegacyExportComponent"]);
...
_FCEO.prototype.render = function(a) {
	a = _FCEO.L.get(a);
	if (!a || !_FCEO.L.isObj(a.innerHTML, "string")) return this.trace(_FCEO.R.errContainer, 10902091233),
	!1;
	this.update();
	try {
...
try {
	_FCEO.playerVersion = typeof _FCEO.__global === "undefined" ? infosoftglobal.FusionChartsUtil.getPlayerVersion() : _FCEO.__global.swfobject.getFlashPlayerVersion()
} catch(err$$1) {
...
_FCEO.relayStream = function(a) {
	...
	if (!_FCEO.L.isObj(a.parameters.exportParameters)) a.parameters.exportParameters = {};
	if (!_FCEO.L.isObj(a.parameters.exportParameters.triggerOrdinal, "number")) a.parameters.exportParameters.triggerOrdinal = _FCEO.flags.c++;
	_FCEO.__global && _FCEO.__global.raiseEvent("ExportReady", a.parameters, _FCEO.__global.core.items[a.meta.DOMId] || _FCEO.__global.core);
	setTimeout(function() {
		typeof window.FC_ExportReady === "function" && FC_ExportReady(a.meta.DOMId)
	},
	0);
	if (_FCEO.probeComponent(b)) return _FCEO.pushStream(b, [a]),
	!0;
...
_FCEO.flushRack = function(a) {
	...
	_FCEO.streamRack[a] && (_FCEO.pushStream(a, _FCEO.streamRack[a]), _FCEO.streamRack[a] = [])
};
...
_FCEO.probeCharts = function() {
	...
	for (e = 0; e < b.length; e++) a = b[e],
	a.parentNode != void 0 && a.parentNode.tagName == "object" || _FCEO.probeChart(a) && d.push(a);
	return d
};
_FCEO.probeChart = function(a) {
	if (a.signature == void 0) return ! 1;
	a = a.signature();
	return _FCEO.L.isString(a) && a.indexOf(_FCEO.R.resChartSig) == 0
};
_FCEO.initializeComponent = function(a, b) { (!b || !b.length || b.length < 1) && _FCEO.trace(_FCEO.R.errArgs, 10902061902);
	var d = !_FCEO.L.isString(b[0]) && b.length == 1; ! d && b.length < 2 && _FCEO.trace(_FCEO.R.errArgs, 10902091732);
	var e = 0,
	f;
	for (f in _FCEO.defaultParameters) a[f] = (d ? b[0][f] : b[e++]) || _FCEO.defaultParameters[f]; (!_FCEO.L.isString(a.id) || !_FCEO.L.isString(a.swfLocation)) && a.trace(_FCEO.R.errArgs, 10902091820);
	_FCEO.playerVersion.major < 10 && (_FCEO.checkFlashVersion && !a.debugMode && !_FCEO.debugMode && alert(_FCEO.R.msgNoPlayer), a.trace(_FCEO.R.errPlayer, 10902182131));
	a.srcObj = new FusionCharts(a.swfLocation, a.id, 0, 0, a.debugMode, _FCEO.__global && !_FCEO.__global.jsBatchExportSupported && {
		renderer: "flash"
	})
};
_FCEO.updateComponent = function(a) {
	a.srcObj || a.trace(_FCEO.R.errFusion, 10902220400);
	_FCEO.L.sync(a.componentAttributes, a.srcObj.variables || a.srcObj.flashVars);
	var b, d = function(b) {
		return ! _FCEO.L.isObj((a.srcObj.variables || a.srcObj.flashVars)[b], "undefined") ? (a.srcObj.variables || a.srcObj.flashVars)[b] : _FCEO.defaultParameters.componentAttributes[b]
	};
	try { (a.srcObj.variables || a.srcObj.flashVars).generator = _FCEO.R.resSig;
		b = d("width");
		if (b != void 0) _FCEO.__global ? (a.srcObj.width = b.toString(), a.srcObj.flashVars.width = b.toString()) : (a.srcObj.setAttribute("width", b), a.srcObj.addVariable("width", b));
		b = d("height");
		if (b != void 0) _FCEO.__global ? (a.srcObj.height = b.toString(), a.srcObj.flashVars.height = b.toString()) : (a.srcObj.setAttribute("height", b), a.srcObj.addVariable("height", b));
		b = d("bgColor");
		b != void 0 && (a.srcObj.params ? a.srcObj.params.bgColor = b: a.srcObj.addParam("bgColor", b));
...
_FCEO.batchExport = function(a, b) {
	if (! (b instanceof Array)) return a.trace(_FCEO.R.errArgs, 10902091853),
	[];
	var d = [],
	e = _FCEO.flags.c;
	...
	h = 0; h < b.length; h++) {
		...
		if (g == null) a.trace(_FCEO.R.errFusion, 10902092026);
		else {
			if (!_FCEO.L.isObj(a.exportAttributes.exportParameters)) a.exportAttributes.exportParameters = {};
			a.exportAttributes.exportParameters.triggerOrdinal = e++;
			a.exportAttributes = f(a.exportAttributes);
			g && g.exportChart ? (g.exportChart(a.exportAttributes), d.push(g.id)) : a.trace(_FCEO.R.errFusion + "\nRef: " + g.id, 10902092036)
		}
	}
	return d
};
...
_FCEO.trace = function(a, b, d) { (d || _FCEO.debugMode) && _FCEO.L.raise(a, b)
};
_FCEO.R = {
...
_FCEO.L = {
	...
	getNew: function(a) {
		for (var b = document.createElement(a), d, e = 1; c < arguments.length; e++) d = arguments[e].split("="),
		b.setAttribute(d[0], d[1]);
		return b
	},
	sync: function(a, b) {
