...
}), window.console.hasDebug = !1), "function" === typeof window.console.warn ? window.console.hasWarn = !0 : ("undefined" === typeof window.console.warn && (window.console.warn = !window.console.hasLog ?
function() {}: function() {
...
}), window.console.hasTrace = !1), window.console.emulated = !0); (function(a) {
	...
	a.fn.findAndSelf = a.fn.findAndSelf ||
	function(b) {
		return a(this).find(b).andSelf().filter(b)
	};
	Number.prototype.replace = Number.prototype.replace ||
	function() {
	...
	a.SyntaxHighlighter ? window.console.warn("SyntaxHighlighter has already been defined...") : a.SyntaxHighlighter = {
		config: {
			...
			prettifyBaseUrl: "http://balupton.github.com/jquery-syntaxhighlighter/prettify",
			baseUrl: "http://balupton.github.com/jquery-syntaxhighlighter"
		},
		init: function(b) {
			var c = this.config,
			d = c.baseUrl;
