...
if(_5e){
//Start:修改节点展开时将原来的参数也传递到后台 add by shf675
//_61.queryParams=_5e;
$.extend(_61.queryParams, _5e);
//End:add by shf675
}
...
//Start:tree列永远居左 add by shf675
var _align = col.align;
if(col.field == _fc.treeField){
_align = "left";
}
_fe+="text-align:"+_align+";";
//End: add by shf675
}
if(!_fc.nowrap){
