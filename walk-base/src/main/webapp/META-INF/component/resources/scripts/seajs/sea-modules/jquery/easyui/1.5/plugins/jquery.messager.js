...
_14=$.extend({},$.messager.defaults,{content:"<div class=\""+cls+"\"></div>"+"<div class=\"messager-text\">"+_14.msg+"</div><div style=\"clear:both;\"/>"},_14);
if(!_14.buttons){
...
_16=$.extend({},$.messager.defaults,{content:"<div class=\"messager-icon messager-question\"></div>"+"<div class=\"messager-text\">"+_16.msg+"</div>"+"<div style=\"clear:both;\"/>"},_16);
if(!_16.buttons){
_16.buttons=[{text:_16.ok,size:'ok',onClick:function(){
_6(dlg,true);
}},{text:_16.cancel,size:'cancel',onClick:function(){
_6(dlg,false);
}}];
}
var dlg=_d(_16);
...
_18=$.extend({},$.messager.defaults,{content:"<div class=\"messager-icon messager-question\"></div>"+"<div class=\"messager-text\">"+_18.msg+"</div>"+"<br/>"+"<div style=\"clear:both;\"/>"+"<div><input class=\"messager-input\" type=\"text\"/></div>"},_18);
if(!_18.buttons){
_18.buttons=[{text:_18.ok,size:'ok',onClick:function(){
_6(dlg,dlg.find(".messager-input").val());
}},{text:_18.cancel,size:'cancel',onClick:function(){
_6(dlg);
}}];
}
var dlg=_d(_18);
