...
_22.panel("panel").show().css({zIndex:($.fn.menu && $.fn.menu.defaults?$.fn.menu.defaults.zIndex++:($.fn.window&&$.fn.window.defaults?$.fn.window.defaults.zIndex++:99)),left:-999999});
//Start:modify by shf675
