...
/*Start:解决ie6下select遮罩层无法遮盖问题 add by shf675*/
if($.isIE8Under()){
_13.mask.bgiframe();
}
/*End:add by shf675*/
...
,onMaximize:function(){
/*Start:最大化时父窗口也随之最大化add by shf675*/
//try{
//$.walk.getTopWindow().maximizePage();
//$.walk.getTopWindow().pageScrollTop();
//var win = $(this);
//setTimeout(function(){win.window('resize');},600);
//}catch(e){}
/*End:add by shf675*/
}
,onRestore:function(){
/*Start: 最小化时父窗口也随之最小化 add by shf675*/
//try{
//$.walk.getTopWindow().minimizePage();
//var win = $(this);
//setTimeout(function(){win.window('resize');},600);
//}catch(e){}
///*End:add by shf675*/
