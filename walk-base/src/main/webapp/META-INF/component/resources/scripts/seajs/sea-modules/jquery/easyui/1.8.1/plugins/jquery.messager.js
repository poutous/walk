...
/*Start: 增加从顶部滑动效果 add by shf675*/
_f.parent().animate({top:'83'}, 400);
_f.parent().next(".window-shadow").animate({top:'83'}, 400);
/*End:add by shf675*/
...
/*modify add by shf675。messager-text */
_15=$.extend({},$.messager.defaults,{content:"<div class=\""+cls+"\"></div>"+"<div class=\"messager-text\">"+_15.msg+"</div>"+"<div style=\"clear:both;\"/>"},_15);
if(!_15.buttons){
...
_17=$.extend({},$.messager.defaults,{content:"<div class=\"messager-icon messager-question\"></div>"+"<div class=\"messager-text\">"+_17.msg+"</div>"+"<div style=\"clear:both;\"/>"},_17);
if(!_17.buttons){
/*modify add by shf675*/
_17.buttons=[{text:_17.ok,size:'ok',onClick:function(){
_6(dlg,true);
}},{text:_17.cancel,size:'cancel',onClick:function(){
_6(dlg,false);
}}];
}
var dlg=_d(_17);
...
_19=$.extend({},$.messager.defaults,{content:"<div class=\"messager-icon messager-question\"></div>"+"<div class=\"messager-text\">"+_19.msg+"</div>"+"<br/>"+"<div style=\"clear:both;\"/>"+"<div><input class=\"messager-input\" type=\"text\"/></div>"},_19);
if(!_19.buttons){
_19.buttons=[{text:_19.ok,size:'ok',onClick:function(){
_6(dlg,dlg.find(".messager-input").val());
}},{text:_19.cancel,size:'cancel',onClick:function(){
_6(dlg);
}}];
}
/*modify add by shf675*/
...
//Start: modify by shf675
//$.messager.defaults=$.extend({},$.fn.dialog.defaults,{ok:"Ok",cancel:"Cancel",width:300,height:"auto",minHeight:150,modal:true,collapsible:false,minimizable:false,maximizable:false,resizable:false,fn:function(){
$.messager.defaults=$.extend({},$.fn.dialog.defaults,{ok:"Ok",cancel:"Cancel",top:-200,width:560,height:"auto",minHeight:150,modal:true,collapsible:false,minimizable:false,maximizable:false,resizable:false,fn:function(){
//End: modify by shf675
}});
})(jQuery);
