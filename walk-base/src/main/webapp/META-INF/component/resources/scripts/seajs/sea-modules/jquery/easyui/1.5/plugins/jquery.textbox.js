...
bc.append("<a href=\"javascript:void(0)\" title=\"点击展开/收起\" class=\"textbox-icon "+bb[i].iconCls+"\" icon-index=\""+i+"\" tabindex=\"-1\"></a>");
}
}
...
//Start:外部宽度加5 add by shf675
_18._outerWidth(_1b+5);
//End:外部宽度加5 add by shf675
if(!_17){
tb.insertAfter(_12);
}
