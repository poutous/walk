...
//Start:添加清空选项 add by shf675
if(_5.clearable == true){
_4.panel.after("<div class=\"combo-clear\"><a href=\"javascript:void(0)\">清空</a></div>");
_4.panel.next(".combo-clear").find("a").bind("click",function(e){
	$(_3).combo('clear');
	if($(_3).combotree){
		$(_3).combotree('clear');
	}
...
_26.panel("panel").show().css({zIndex:($.fn.menu && $.fn.menu.defaults?$.fn.menu.defaults.zIndex++:($.fn.window&&$.fn.window.defaults?$.fn.window.defaults.zIndex++:99)),left:-999999});
//Start:modify by shf675
