...
$.extend($.walk, {
	...
	showFileDiv: function (fileElementId, files) {
		...
		'	<img class="folder" src="'+$.walk.ctx+'/static/component/resources/scripts/seajs/sea-modules/jquery/ajaxfileupload/1.0.0/images/folder.png" alt="" />' +
		'	<span class="file">' +
		'		<a class="fileName" href="javascript:void(0)"></a>' +
		'		<a class="fileSize" href="javascript:void(0)"></a>' +
		'	</span>' +
		'	<img class="download" src="'+$.walk.ctx+'/static/component/resources/scripts/seajs/sea-modules/jquery/ajaxfileupload/1.0.0/images/download.png" alt="" />' +
		'	<img class="delete" src="'+$.walk.ctx+'/static/component/resources/scripts/seajs/sea-modules/jquery/ajaxfileupload/1.0.0/images/delete.png" alt="" />' +
		'</div>';
