...
<script type="text/javascript" src="${request.contextPath}/component/resources/scripts/seajs/sea-modules/jquery/jquery/1.12.4/jquery-extend.js?_v=20170813"></script>
...
<script type="text/javascript" src="${request.contextPath}/component/resources/scripts/seajs/sea-modules/init.js?_v=20170813"></script>
</#if>
