...
<script type="text/javascript" src="${request.contextPath}/static/component/resources/scripts/seajs/sea-modules/??seajs/seajs/2.2.1/sea.js,seajs/seajs-combo/1.0.1/seajs-combo.js,config.js,jquery/jquery/jquery.js,jquery/jquery/jquery-extend.js,jquery/easyui/1.8.1/easyloader.sea.js,walk.js,init.js"></script>
<#else>
...
<script type="text/javascript" src="${request.contextPath}/static/component/resources/scripts/seajs/sea-modules/jquery/jquery/jquery.js"></script>
<script type="text/javascript" src="${request.contextPath}/static/component/resources/scripts/seajs/sea-modules/jquery/jquery/jquery-extend.js"></script>
