...
<script type="text/javascript" src="${request.contextPath}/component/resources/scripts/seajs/sea-modules/jquery/easyui/1.8.1/easyloader.sea.js"></script>
