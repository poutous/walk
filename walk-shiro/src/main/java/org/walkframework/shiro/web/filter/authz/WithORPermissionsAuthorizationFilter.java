...
/**
 * 拓展org.apache.shiro.web.filter.authz.PermissionsAuthorizationFilter
 * shiro默认只支持且，不支持或，现拓展以支持or
 * 
 * @author shf675
 * 
 */
public class WithORPermissionsAuthorizationFilter extends PermissionsAuthorizationFilter {
